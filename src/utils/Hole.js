...
class Hole {
    constructor(opts, element, colorTrue) {
        // if (Hole.instance) {
...
class World {
    constructor(opts, element) {
        ...
        // console.log(element);
        World.defaultOpts.container = element
    ...
    initCamera() {
        this.camera = new THREE.PerspectiveCamera(this.opts.camFov, this.element.offsetWidth / this.element.offsetHeight, this.opts.camNear, this.opts.camFar)
